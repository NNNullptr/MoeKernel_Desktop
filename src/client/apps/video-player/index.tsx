...
const VIDEO_CONFIG = {
  ...
  nowPlayingGradientStart: '#003366',
  nowPlayingGradientMid: '#005599',
  nowPlayingAccentColor: '#7ec8ff',
  ...
  progressFillStart: '#3399ff',
  progressFillEnd: '#66bbff',
  // 进度条可拖拽滑块颜色
  progressThumbColor: '#66bbff',
  volumeFillColor: '#3399ff',
  statusBarBg: '#111111',
