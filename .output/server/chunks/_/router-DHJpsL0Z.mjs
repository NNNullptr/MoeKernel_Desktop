...
function TrpcProvider(props) {
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, "data-cid": "k3ygj4pd", children: props.children });
}
const Route$i = createRootRoute({
  component: RootDocument
});
function RootDocument() {
  return /* @__PURE__ */ jsxs("html", { "data-cid": "a2pJeNK0", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("title", { children: "moekernel" }),
...
const $$splitComponentImporter$g = () => import("./index-BYSTLXlR.mjs");
const Route$h = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./login-VnUJ1pHc.mjs");
const Route$g = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./_layout-otlQsQaj.mjs");
...
const SANITIZED_CODES = /* @__PURE__ */ new Set([
  "NOT_FOUND",
  "CONFLICT",
...
const t = initTRPC.context().create({
  ...
  errorFormatter({ shape }) {
    if (SANITIZED_CODES.has(shape.data.code)) {
  ...
  check(ip) {
    ...
    if (entry.lockedUntil !== null) {
      if (now < entry.lockedUntil) {
        const retryAfterSec = Math.ceil((entry.lockedUntil - now) / 1e3);
...
function NotFound() {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-screen w-screen overflow-hidden", "data-cid": "lmniAnL9", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-bold", children: "404 - Not Found" }) });
}
function getRouter() {
