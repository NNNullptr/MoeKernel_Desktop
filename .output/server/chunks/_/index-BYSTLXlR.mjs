...
function StartMenu({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    borderBottom: "none"
  }, onClick: (e) => e.stopPropagation(), "data-cid": "sbXSnvyH", children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsx(FooterBtn, { label: "Log Off", icon: /* @__PURE__ */ jsx(LogOffIcon, {}), onClick: onLogOff }),
      /* @__PURE__ */ jsx(FooterBtn, { label: "Turn Off Computer", icon: /* @__PURE__ */ jsx(PowerIcon, {}), onClick: onTurnOff })
    ] })
  ] });
}
function Divider({
...
function LogOffIcon() {
  return /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 16 16", "aria-hidden": "true", focusable: "false", "data-cid": "IuMXtzlK", children: [
    /* @__PURE__ */ jsx("path", { d: "M6.5 2.5H3.75A1.25 1.25 0 0 0 2.5 3.75v8.5c0 .69.56 1.25 1.25 1.25H6.5", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx("path", { d: "M7 8h7m-2.6-2.6L14 8l-2.6 2.6", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function PowerIcon() {
  return /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 16 16", "aria-hidden": "true", focusable: "false", "data-cid": "Bb01feJJ", children: [
    /* @__PURE__ */ jsx("path", { d: "M8 1.75v6", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx("path", { d: "M4.25 4.55a5.5 5.5 0 1 0 7.5 0", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
...
function ResizeHandle({
  ...
  return /* @__PURE__ */ jsx("div", { style, onPointerDown: handlePointerDown, onPointerMove: handlePointerMove, onPointerUp: handlePointerUp, "data-cid": "26ZSIfPV" });
}
function XpWindow({
  win,
  onFocus,
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$d,
    userSelect: "none"
  }, onPointerDown: () => onFocus(win.id), "data-cid": "fqzmHCvM", children: [
...
function WinBtn({
  ...
  return /* @__PURE__ */ jsx("button", { "data-window-btn": true, title, onClick: (e) => {
    ...
    flexShrink: 0,
    padding: 0
  }, "data-cid": "Nd7ebUyE", children: label });
}
const ICON_SIZE = 80;
const ICON_GAP = 4;
...
function RightSidebar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    overflowX: "hidden",
    scrollbarWidth: "none"
  }, "data-cid": "dsUJOdbu", children: pets.map((pet) => /* @__PURE__ */ jsx(PetButton, { pet, active: activePetIds.has(pet.id), onToggle }, pet.id)) });
}
function PetButton({
  pet,
  active,
...
function MyComputerApp() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      items.map((item) => {
        if (item.type === "folder") {
          return /* @__PURE__ */ jsx(FileTile, { label: item.name, iconSrc: item.icon ?? "/assets/icons/1.png", onClick: () => setCurrentPath((p) => [...p, item.name]), "data-cid": "ds62CNoW" }, item.name);
        }
        const fileType = inferFileType(item.name);
        const url = getPublicUrl([...currentPath, item.name]);
        return /* @__PURE__ */ jsx(FileTile, { label: item.name, imageSrc: fileType === "image" ? url : void 0, videoSrc: fileType === "video" ? url : void 0, iconSrc: fileType === "audio" ? "/assets/icons/Media.png" : item.icon ?? DEFAULT_FILE_ICON, onClick: () => handleFileClick(item), "data-cid": "IfVdWrdd" }, item.name);
      }),
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx(
          "iframe",
          {
            ...
            allow: "fullscreen",
            sandbox: playingGame.url.startsWith("/") ? "allow-scripts allow-same-origin allow-forms allow-pointer-lock" : "allow-scripts allow-forms allow-pointer-lock",
            style: {
              position: "absolute",
              inset: 0,
              width: "100%",
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      transportButtons.map(({
        ...
        }, "data-cid": "ndwWO5i8", children: iconStr }, id);
      }),
      /* @__PURE__ */ jsx("span", { style: {
        fontSize: "10px",
        color: "#aaa",
...
function Lightbox({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$5,
    padding: "24px"
  }, onClick: onClose, "data-cid": "1RpDLWJI", children: [
...
function CategoryTabBar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    flexShrink: 0,
    overflowX: "auto"
  }, "data-cid": "sEbFL8wr", children: categories.map((cat) => {
    ...
    return /* @__PURE__ */ jsx("button", { onClick: () => onSelect(cat), style: {
      ...
      transition: "background 0.1s"
    }, "data-cid": "F-ebqFGK", children: cat }, cat);
  }) });
}
...
function BlogPostViewer({
  ...
  if (!post) {
    return /* @__PURE__ */ jsx("div", { style: {
      ...
      background: "#fff",
      fontFamily: FONT$2
    }, "data-cid": "Cq4GpIIN", children: /* @__PURE__ */ jsx("span", { style: {
      color: "#888",
      fontSize: "12px"
    }, children: "正在加载文章内容..." }) });
  }
...
function WindowContent({
  ...
  if (app) {
    ...
    return /* @__PURE__ */ jsx(AppComponent, { "data-cid": "klDEOAWu" });
  }
  if (documents.some((d) => d.id === id)) {
    return /* @__PURE__ */ jsx(ResumeApp, { documentId: id, "data-cid": "0XWlCbIO" });
  }
  return /* @__PURE__ */ jsx("div", { style: {
    padding: "20px",
    fontFamily: '"Trebuchet MS", Tahoma, sans-serif',
    fontSize: "13px"
  }, "data-cid": "BTBEmEuz", children: /* @__PURE__ */ jsxs("p", { children: [
    "Content for ",
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { id: "root", onClick: handleDesktopClick, "data-cid": "_Ab0Db-w", children: [
