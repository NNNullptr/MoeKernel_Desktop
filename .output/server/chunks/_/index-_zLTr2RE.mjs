...
import { t as trpc } from "./router-Dg4MpxXb.mjs";
...
function StartMenu({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    borderBottom: "none"
  }, onClick: (e) => e.stopPropagation(), "data-cid": "DNc3aZxo", children: [
...
function ResizeHandle({
  ...
  return /* @__PURE__ */ jsx("div", { style, onPointerDown: handlePointerDown, onPointerMove: handlePointerMove, onPointerUp: handlePointerUp, "data-cid": "ARvUm10n" });
}
function XpWindow({
  win,
  onFocus,
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$c,
    userSelect: "none"
  }, onPointerDown: () => onFocus(win.id), "data-cid": "BudcAzX6", children: [
...
function WinBtn({
  ...
  return /* @__PURE__ */ jsx("button", { "data-window-btn": true, title, onClick: (e) => {
    ...
    flexShrink: 0,
    padding: 0
  }, "data-cid": "OI_8v10D", children: label });
}
const ICON_SIZE = 80;
const ICON_GAP = 4;
...
function RightSidebar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    overflowX: "hidden",
    scrollbarWidth: "none"
  }, "data-cid": "7B4YeGxF", children: pets.map((pet) => /* @__PURE__ */ jsx(PetButton, { pet, active: activePetIds.has(pet.id), onToggle }, pet.id)) });
}
function PetButton({
  pet,
  active,
...
function MyComputerApp() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      items.map((item) => {
        if (item.type === "folder") {
          return /* @__PURE__ */ jsx(FileTile, { label: item.name, iconSrc: item.icon ?? "/assets/icons/Games.png", onClick: () => setCurrentPath((p) => [...p, item.name]), "data-cid": "jHVea5fk" }, item.name);
        }
        const fileType = inferFileType(item.name);
        const url = getPublicUrl([...currentPath, item.name]);
        return /* @__PURE__ */ jsx(FileTile, { label: item.name, imageSrc: fileType === "image" ? url : void 0, videoSrc: fileType === "video" ? url : void 0, iconSrc: fileType === "audio" ? "/assets/icons/Media.png" : item.icon ?? DEFAULT_FILE_ICON, onClick: () => handleFileClick(item), "data-cid": "I--Too_O" }, item.name);
      }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      transportButtons.map(({
        ...
        }, "data-cid": "uUlbhbEM", children: iconStr }, id);
      }),
      /* @__PURE__ */ jsx("span", { style: {
        fontSize: "10px",
        color: "#aaa",
...
function Lightbox({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$5,
    padding: "24px"
  }, onClick: onClose, "data-cid": "Er6yZIV5", children: [
...
function CategoryTabBar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    flexShrink: 0,
    overflowX: "auto"
  }, "data-cid": "vHGKBwZu", children: categories.map((cat) => {
    ...
    return /* @__PURE__ */ jsx("button", { onClick: () => onSelect(cat), style: {
      ...
      transition: "background 0.1s"
    }, "data-cid": "IURFAGOH", children: cat }, cat);
  }) });
}
...
function BlogPostViewer({
  ...
  if (!post) {
    return /* @__PURE__ */ jsx("div", { style: {
      ...
      background: "#fff",
      fontFamily: FONT$2
    }, "data-cid": "_FM0GwjU", children: /* @__PURE__ */ jsx("span", { style: {
      color: "#888",
      fontSize: "12px"
    }, children: "正在加载文章内容..." }) });
  }
...
function WindowContent({
  ...
  if (app) {
    ...
    return /* @__PURE__ */ jsx(AppComponent, { "data-cid": "wwb94svV" });
  }
  return /* @__PURE__ */ jsx("div", { style: {
    padding: "20px",
    fontFamily: '"Trebuchet MS", Tahoma, sans-serif',
    fontSize: "13px"
  }, "data-cid": "LwEJ6oa6", children: /* @__PURE__ */ jsxs("p", { children: [
    "Content for ",
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { id: "root", onClick: handleDesktopClick, "data-cid": "EixzE9sz", children: [
