...
function TrpcProvider(props) {
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, "data-cid": "PNZN9DNp", children: props.children });
}
const Route$i = createRootRoute({
  component: RootDocument
});
function RootDocument() {
  return /* @__PURE__ */ jsxs("html", { "data-cid": "zg7BmuwW", children: [
...
const $$splitComponentImporter$g = () => import("./index-IPHx2a4s.mjs");
const Route$h = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./login-Cfy8yhsn.mjs");
const Route$g = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./_layout-DCveOrYy.mjs");
...
function NotFound() {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-screen w-screen overflow-hidden", "data-cid": "auFL38JH", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-bold", children: "404 - Not Found" }) });
}
function getRouter() {
