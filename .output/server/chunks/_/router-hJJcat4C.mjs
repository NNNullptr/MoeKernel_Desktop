...
function TrpcProvider(props) {
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, "data-cid": "vSVNLdR7", children: props.children });
}
const Route$b = createRootRoute({
  component: RootDocument
});
function RootDocument() {
  return /* @__PURE__ */ jsxs("html", { "data-cid": "0sR1npFL", children: [
...
const $$splitComponentImporter$9 = () => import("./index-CV2YIkie.mjs");
const Route$a = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./login-DsiNarl0.mjs");
const Route$9 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./_layout-D8--8JN2.mjs");
const Route$8 = createFileRoute("/admin/_layout")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./index-CBkGdXBO.mjs");
const Route$7 = createFileRoute("/admin/_layout/")({
...
const Route$6 = createFileRoute("/api/trpc/$")({
  server: {
    handlers: {
      GET: handler,
      POST: handler
...
const $$splitComponentImporter$5 = () => import("./theme-BFVNak58.mjs");
const Route$5 = createFileRoute("/admin/_layout/theme")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./mascots-ClbWsAd0.mjs");
const Route$4 = createFileRoute("/admin/_layout/mascots")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./icons-B8-jMEox.mjs");
const Route$3 = createFileRoute("/admin/_layout/icons")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-DMgJxARZ.mjs");
const Route$2 = createFileRoute("/admin/_layout/blog/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./new-ZSnqO-UN.mjs");
const Route$1 = createFileRoute("/admin/_layout/blog/new")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_id-B7tP4zY6.mjs");
...
const AdminLayoutRoute = Route$8.update({
  id: "/admin/_layout",
  path: "/admin",
  getParentRoute: () => Route$b
});
const AdminLayoutIndexRoute = Route$7.update({
  id: "/",
  path: "/",
  getParentRoute: () => AdminLayoutRoute
});
const ApiTrpcSplatRoute = Route$6.update({
  id: "/api/trpc/$",
  path: "/api/trpc/$",
  getParentRoute: () => Route$b
});
const AdminLayoutThemeRoute = Route$5.update({
  id: "/theme",
  path: "/theme",
  getParentRoute: () => AdminLayoutRoute
});
const AdminLayoutMascotsRoute = Route$4.update({
  id: "/mascots",
  path: "/mascots",
  getParentRoute: () => AdminLayoutRoute
});
const AdminLayoutIconsRoute = Route$3.update({
  id: "/icons",
  path: "/icons",
  getParentRoute: () => AdminLayoutRoute
});
...
function NotFound() {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-screen w-screen overflow-hidden", "data-cid": "O9QVPCiQ", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-bold", children: "404 - Not Found" }) });
}
function getRouter() {
