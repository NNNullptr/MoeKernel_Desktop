...
function StartMenu({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    borderBottom: "none"
  }, onClick: (e) => e.stopPropagation(), "data-cid": "zY706Pe6", children: [
...
function ResizeHandle({
  ...
  return /* @__PURE__ */ jsx("div", { style, onPointerDown: handlePointerDown, onPointerMove: handlePointerMove, onPointerUp: handlePointerUp, "data-cid": "MFHodmDp" });
}
function XpWindow({
  win,
  onFocus,
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$d,
    userSelect: "none"
  }, onPointerDown: () => onFocus(win.id), "data-cid": "rk4PrDnW", children: [
...
function WinBtn({
  ...
  return /* @__PURE__ */ jsx("button", { "data-window-btn": true, title, onClick: (e) => {
    ...
    flexShrink: 0,
    padding: 0
  }, "data-cid": "QUiXcIIv", children: label });
}
const ICON_SIZE = 80;
const ICON_GAP = 4;
...
function RightSidebar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    overflowX: "hidden",
    scrollbarWidth: "none"
  }, "data-cid": "RLqjbA2O", children: pets.map((pet) => /* @__PURE__ */ jsx(PetButton, { pet, active: activePetIds.has(pet.id), onToggle }, pet.id)) });
}
function PetButton({
  pet,
  active,
...
function MyComputerApp() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      items.map((item) => {
        if (item.type === "folder") {
          return /* @__PURE__ */ jsx(FileTile, { label: item.name, iconSrc: item.icon ?? "/assets/icons/Games.png", onClick: () => setCurrentPath((p) => [...p, item.name]), "data-cid": "iIjPucSF" }, item.name);
        }
        const fileType = inferFileType(item.name);
        const url = getPublicUrl([...currentPath, item.name]);
        return /* @__PURE__ */ jsx(FileTile, { label: item.name, imageSrc: fileType === "image" ? url : void 0, videoSrc: fileType === "video" ? url : void 0, iconSrc: fileType === "audio" ? "/assets/icons/Media.png" : item.icon ?? DEFAULT_FILE_ICON, onClick: () => handleFileClick(item), "data-cid": "-KJhmzPt" }, item.name);
      }),
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      transportButtons.map(({
        ...
        }, "data-cid": "51TkCUxj", children: iconStr }, id);
      }),
      /* @__PURE__ */ jsx("span", { style: {
        fontSize: "10px",
        color: "#aaa",
...
function Lightbox({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    fontFamily: FONT$5,
    padding: "24px"
  }, onClick: onClose, "data-cid": "TvhhGqYE", children: [
...
function CategoryTabBar({
  ...
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    flexShrink: 0,
    overflowX: "auto"
  }, "data-cid": "MrM84feM", children: categories.map((cat) => {
    ...
    return /* @__PURE__ */ jsx("button", { onClick: () => onSelect(cat), style: {
      ...
      transition: "background 0.1s"
    }, "data-cid": "GpiCHizh", children: cat }, cat);
  }) });
}
...
function BlogPostViewer({
  ...
  if (!post) {
    return /* @__PURE__ */ jsx("div", { style: {
      ...
      background: "#fff",
      fontFamily: FONT$2
    }, "data-cid": "Z_PDr2BO", children: /* @__PURE__ */ jsx("span", { style: {
      color: "#888",
      fontSize: "12px"
    }, children: "正在加载文章内容..." }) });
  }
...
function WindowContent({
  ...
  if (app) {
    ...
    return /* @__PURE__ */ jsx(AppComponent, { "data-cid": "ZmbEvNos" });
  }
  if (documents.some((d) => d.id === id)) {
    return /* @__PURE__ */ jsx(ResumeApp, { documentId: id, "data-cid": "6AY-9KF9" });
  }
  return /* @__PURE__ */ jsx("div", { style: {
    padding: "20px",
    fontFamily: '"Trebuchet MS", Tahoma, sans-serif',
    fontSize: "13px"
  }, "data-cid": "7iqIcDbn", children: /* @__PURE__ */ jsxs("p", { children: [
    "Content for ",
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { id: "root", onClick: handleDesktopClick, "data-cid": "utym4Fyi", children: [
